...
public class StatusLogTest {
    ...
    void addError_string_shouldAddFehlerMeldung() {
        ...
        var meldungen = StatusLog.getInstance().getStatusLogEintraege();
    ...
    void addError_exception_shouldAddFehlerMeldungWithStackTrace() {
        var exception = new RuntimeException("TestExceptionFehler1");
        StatusLog.addError(exception);
        var meldungen = StatusLog.getInstance().getStatusLogEintraege().getFirst();
